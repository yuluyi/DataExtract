...
function SjZViewer(baseServer,baseImage,width,height,newWidth, newHeight,transparency,inLegacyLoadEventData,imgVersion,inView,pageId,inParams){
	...
	this.zviewer.serverURL = baseServer;
	this.zviewer.baseImage = baseImage;
...
/////////////////////////////
					url = serverURL+"/"+escape(res[3])+"?req=message&message="+logAr.sessionId+","+logAr.timeStamp+",LOAD,"+sjZoomViewer.viewerType+","+sj.version+",0,-1,-1,-1,"+escape(res[3])+"/"+escape(res[4]); 
